...
<body>
	...
	<div class="container">
		<p>En esta aplicación podra realizar lo siguiente:</p>

		<li>Consultar directores</li>
		<li>Ver las peliculas de un director</li>
		<li>Realizar un login</li>
		<li>Crear una nueva pelicula</li>
		<li>Crear un nuevo admin</li>
