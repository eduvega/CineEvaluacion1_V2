...
<body>
	...
	<div class="container">
		<div class=" d-flex justify-content-between">
			<a class="btn btn-success mt-5 mb-3 text-light"
				href="${pageContext.request.contextPath}/peliculaServlet?accion=insertar">Insertar</a>
			...
			<tbody>
				<c:forEach var="pelicula" items="${peliculas}">
					...
					<tr class="lead text-center">
						...
						<td><a
							href="${pageContext.request.contextPath}/peliculaServlet?accion=editar&id=${pelicula.id}"
							class="btn btn-success">Actualizar</a></td>
						<td><a
							href="${pageContext.request.contextPath}/peliculaServlet?accion=eliminar&id=${pelicula.id}"
